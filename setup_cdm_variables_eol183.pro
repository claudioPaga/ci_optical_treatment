...
;;;                SBC
;;;
;;; 2 Dec 2021 - Set temperature to T=-90C (183K) to test possible
;;;               warmer regimes.  
;;;
...
charge_injection_period_frame = 100 ; Lines gap between CI lines at the top of image after exposure.
