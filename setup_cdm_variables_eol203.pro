...
;;;
;;; To load the file and check a few pars:
;;;  
...
;;;  print, 'Temperature = ',  ccd_t_kelvin
;;;  print, 'Release timescales = ', release_image_time   
;;;  print, 'CI frequency = ', charge_injection_period_frame
;;;  
;;; History -
...
;;;                SBC
;;;
;;; 23 Dec 2021 - Set temperature to T=-70C (203K) to test possible
;;;               warmer regimes.
;;;
